...
public class CustomerHasFreeShippingSpecification implements Specification<Customer> {
    ...
    public CustomerHasFreeShippingSpecification(Orders orders, LoyaltyPoints basicLoyaltyPoints,
    ...
    public boolean isSatisfiedBy(Customer customer) {
        ...
        return hasEnoughBasicLoyaltyPoints.and(
                hasOrderedEnoughAtYear
        ).or(hasEnoughPremiumLoyaltyPoints).isSatisfiedBy(customer);
    }
}
