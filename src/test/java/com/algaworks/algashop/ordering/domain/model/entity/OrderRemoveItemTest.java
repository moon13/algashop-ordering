...
import com.algaworks.algashop.ordering.domain.model.exceptions.OrderDoesNotContainOrderItemExeception;
...
public class OrderRemoveItemTest {
    ...
    void givenDraftOrder_whenTryToRemoveNoExistingItem_shouldGenerateException() {
        ...
        Assertions.assertWith(order,
                (i) -> Assertions.assertThat(i.totalAmount()).isEqualTo(new Money("6410.00")),
                (i) -> Assertions.assertThat(i.totalItems()).isEqualTo(new Quantity(4))
        );
    }
