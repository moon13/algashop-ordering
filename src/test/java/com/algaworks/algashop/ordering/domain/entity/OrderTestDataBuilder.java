...
public class OrderTestDataBuilder {
     ...
     private LocalDate exepectedDeliveryDate = LocalDate.now().plusWeeks(1);
    ...
    public OrderTestDataBuilder exepectedDeliveryDate(LocalDate exepectedDeliveryDate) {
        this.exepectedDeliveryDate = exepectedDeliveryDate;
        return this;
    }
    ...
    public OrderTestDataBuilder orderStatus(OrderStatus orderStatus) {
     ...
     public Order build(){
        ...
        order.changeShipping(shippingInfo,shippingCost,exepectedDeliveryDate);
        order.changeBilling(billingInfo);
        order.changePaymentMethod(paymentMethod);

        if(withItems){
         order.addItem(new ProductId(), new ProductName("Notebook X11"), new Money("3000"),
                 new Quantity(2));
            order.addItem(new ProductId(), new ProductName("4GM RAM"), new Money("200"),
                    new Quantity(2));
