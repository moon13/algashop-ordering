...
import com.algaworks.algashop.ordering.domain.model.exceptions.OrderInvalidShippingDeliveryDateException;
...
import com.algaworks.algashop.ordering.domain.model.valueobject.id.ProductId;import org.assertj.core.api.Assertions;
...
class OrderTest {
    ...
    public void givenDraftOrder_whenChangeItem_shouldRecalculate(){
        ...
        OrderItem orderItem = order.items().iterator()
                .next();
     ...
     @Test
    public void givenOutOfStockProduct_whenTryToAddAnOrder_shouldNotAllow(){
        Order order = Order.draft(new CustomerId());
