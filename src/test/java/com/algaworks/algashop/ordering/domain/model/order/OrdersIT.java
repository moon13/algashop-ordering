...
class OrdersIT {
   ...
   @Test
    ...
    public void shouldListExistingOrdersByYear(){
         orders.add(
                 OrderTestDataBuilder.anOrder().orderStatus(OrderStatus.PLACED).build()
         );
        orders.add(
                OrderTestDataBuilder.anOrder().orderStatus(OrderStatus.PLACED).build()
        );
        ...
        orders.add(
                OrderTestDataBuilder.anOrder().orderStatus(OrderStatus.CANCELED).build()
        );

        orders.add(
                OrderTestDataBuilder.anOrder().orderStatus(OrderStatus.DRAFT).build()
        );
    ...
    public void shouldReturnTotalSoldByCustomer() {
        Order order1 = OrderTestDataBuilder.anOrder().orderStatus(OrderStatus.PAID).build();
        Order order2 = OrderTestDataBuilder.anOrder().orderStatus(OrderStatus.PAID).build();
